...
def parse_orbtials(job_name, mol_dic):
    """
    Parses the orbital information for a given job and molecule dictionary.

    Parameters:
    job_name (str): The name of the job.
    mol_dic (dict): A dictionary containing the molecule information.

    Returns:
    tuple: A tuple containing the Homo, Lumo, Energy Gap, and successful molecules.
