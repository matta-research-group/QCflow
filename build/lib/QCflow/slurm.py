...
def write_slurm(job_name, mol_name, cpus=10):
    ...
    with open(file_name, 'w') as file:
        ...
        file.write(' \n')
        file.write(rf'echo "G16 job \$SLURM_JOBID" \n')
        file.write(rf'echo "INPUT \$INPUTFILE" \n')
        file.write(rf'echo "OUTPUT \$OUTPUTFILE" \n')
        file.write(rf'echo "Running \$SLURM_NTASKS on \$SLURM_JOB_NODELIST" \n')
        file.write(' \n')
