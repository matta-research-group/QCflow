...
def find_dihedral_from_mol(mol3d):
    """
    Finds the dihedral (torsion) angles from a 3D molecular structure.

    Parameters:
        mol3d: A 3D RDKit molecular structure object.

    Returns:
        A tuple containing four atoms that form the dihedral angle.
    """
