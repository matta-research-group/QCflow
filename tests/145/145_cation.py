...
with open('145_opt_c.xyz', 'w') as xyz_file:
...
with open('145_opt_c_energy_and_gap.txt', 'w') as file:
...
mol_sp = psi4.geometry(open('145_opt_c.xyz').read())
...
with open('145_n_c_geo_energy_and_gap.txt', 'w') as file:
