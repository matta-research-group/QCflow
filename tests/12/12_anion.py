...
with open('12_opt_a.xyz', 'w') as xyz_file:
...
with open('12_opt_a_energy_and_gap.txt', 'w') as file:
...
mol_sp = psi4.geometry(open('12_opt_a.xyz').read())
...
with open('12_n_a_geo_energy_and_gap.txt', 'w') as file:
