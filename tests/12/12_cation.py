...
mol = psi4.geometry(open('12_opt.xyz').read())
...
with open('12_opt_c.xyz', 'w') as xyz_file:
...
with open('12_opt_c_energy_and_gap.txt', 'w') as file:
...
mol_sp = psi4.geometry(open('12_opt_c.xyz').read())
...
with open('12_n_c_geo_energy_and_gap.txt', 'w') as file:
